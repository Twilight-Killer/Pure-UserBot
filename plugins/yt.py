...
async def ytm(_, message: Message):
    ...
    await message.edit_text("<b><emoji id=5821116867309210830>🔃</emoji> Ищу...</b>")
    ...
    await message.edit_text("<b><emoji id=5821116867309210830>🔃</emoji> Скачиваю...</b>")
